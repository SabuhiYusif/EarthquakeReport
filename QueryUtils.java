...
public class QueryUtils {
    ...
    public static ArrayList<EarthQuake> extractEarthquakes() {
        ...
        try {
            //Convert Sample into JSONObject
            ...
            for (int i = 0; i<features.length();i++){
                ...
                JSONObject properties = f.optJSONObject("properties");
...
//                Add earthquake to list of earthquakes
    ...
    public static List<EarthQuake> fetchEarthquakeData(String requestUrl) {
        ...
        Log.d("Earthquak","FetchQuakeDataCalled");
        ...
        List<EarthQuake> earthquakes = extractEarthquakeData(jsonResponse);
    ...
    private static URL createUrl(String Stringurl){
        ...
        try{
            ...
            Log.e("QUERY UTILS", "Error while creating url", e);
        }
        return url;
    ...
    private static String makeHTTPRequest(URL url) throws IOException{
        ...
        try {
            ...
            if(httpURLConnection.getResponseCode()== 200){
                ...
                Log.d("QUeryList", "Error Response code "+ httpURLConnection.getResponseCode());
            }
        }catch(IOException e) {
            Log.e("QUERYLIST", "Problem while making connection", e);
        }finally {
    ...
    public static List<EarthQuake> extractEarthquakeData(String earthquakeJSON){
        ...
        try{
            ...
            if (featureArray.length()>0){
                for(int i=0; i< featureArray.length(); i++){
                    JSONObject objects = featureArray.getJSONObject(i);
...
//              Create Earthquake java object from magnitude, location, and time
//                Add earthquake to list of earthquakes
                    EarthQuake earthQuake = new EarthQuake(magnitude,place,mTimeInMilliSeconds,url);
